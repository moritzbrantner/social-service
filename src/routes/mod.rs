...
pub fn router() -> Router<AppState> {
    Router::new()
        ...
        .route("/conversations", post(chat::create_conversation).get(chat::list_conversations))
        .route(
...
pub async fn features(axum::extract::State(state): axum::extract::State<AppState>) -> Json<FeaturesResponse> {
